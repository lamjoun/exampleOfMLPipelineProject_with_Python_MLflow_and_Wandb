...
def go(args):
    ...
    # Get data file() from W&B
    logger.info("Getting data file() from W&B ...")
    trainval_local_path = run.use_artifact(args.trainval_artifact).file()
    logger.info("Data file(): " + trainval_local_path)
    ...
    #
    logger.info("Creating the artifact object for model ...")
    sk_pipe_artifact = wandb.Artifact(
        name=args.output_artifact,
        type="model_export",
        description="Random forest model",
        metadata=rf_config,
    )
    logger.info("Adding the directory to this artifact object ...")
    sk_pipe_artifact.add_dir("random_forest_dir")
    #
    logger.info("log artifact to the run ...")
    run.log_artifact(sk_pipe_artifact)
